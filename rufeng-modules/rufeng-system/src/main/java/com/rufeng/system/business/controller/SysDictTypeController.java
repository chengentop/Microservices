...
public class SysDictTypeController extends BaseController {
     ...
     * @return ResultData
     */
    @Log(title = "根据字典类型获取字典类型", businessType = BusinessType.OTHER)
    @RequestMapping(value = "/{dicttype}", method = {RequestMethod.GET})
    public R<List<SysDictData>> getByDictType(@PathVariable String dicttype) throws Exception {
        //These code is generated by machine, if you want to modify the code, suggest you to remove this line
        List<SysDictData> dictDatas = sysdicttypeService.getByDictType(dicttype);
        return R.ok(dictDatas);
    }
