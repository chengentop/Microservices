...
import com.rufeng.common.core.utils.ip.BrowserUtils;
...
public class TokenService {
    ...
    public Map<String, Object> createToken(LoginUser loginUser) {
        ...
        loginUser.setBrowser(BrowserUtils.getBrowserName(ServletUtils.getRequest()));
        loginUser.setOs(BrowserUtils.getOsName(ServletUtils.getRequest()));
